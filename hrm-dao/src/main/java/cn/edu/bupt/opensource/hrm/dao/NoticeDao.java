...
import cn.edu.bupt.opensource.hrm.dao.provider.NoticeDynaSqlProvider;
import cn.edu.bupt.opensource.hrm.domain.pojo.Notice;
...
import static cn.edu.bupt.opensource.hrm.common.util.contant.HrmConstants.NOTICETABLE;
...
public interface NoticeDao {
    ...
    @Results({
            ...
            @Result(column="USER_ID",property="user",
                    one=@One(select="cn.edu.bupt.opensource.hrm.dao.UserDao.selectById",
